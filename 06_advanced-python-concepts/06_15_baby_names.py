...
# filter(function, args) .startswith(prefix)

m_names = filter(lambda i: True if i.startswith("M") else False, names)

for y in m_names:
    print(y)

#This feels so much more complex than it would need to be.